    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-[#163A5F] to-[#2E6F9E] rounded-2xl p-6 text-white shadow relative overflow-hidden">
        ...
        <div className="relative flex justify-between items-start">
          <div>
            <p className="text-white/70 text-sm">Hola, {profile?.nombre ?? 'Admin'} — {new Date().toLocaleDateString('es-AR', { weekday:'long', day:'numeric', month:'long' })}</p>
            <h1 className="text-3xl font-display font-bold mt-1">Aresa Fichaje</h1>
            <p className="text-white/80 mt-1">Todo tu equipo, a la vista y tranquilo</p>
          </div>
